...
def prov_base_config_24p_distro(output_dir):

    #loads in the j2 and csv files
    base_config_j2 = os.path.join(cwd, j2s, "24p_distro_template.j2")
...
def main():
    ...
    clean_slate()
    prov_base_config_24p_distro(generated_configs_path)
