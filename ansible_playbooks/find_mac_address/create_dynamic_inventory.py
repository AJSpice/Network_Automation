...
def clean_slate():
    ...
    hosts_file_path = os.path.expanduser("~/ansible/ansible_playbooks/find_mac_address/hosts.yml")
    nmap_output_path = os.path.expanduser("~/ansible/ansible_playbooks/find_mac_address/nmap_output.json")
